...
# Menampilkan SO2 di Kota Changping
st.subheader("Indeks Polusi SO2 di Kota Changping")
changping_data = all_df[all_df['station'] == 'Changping']
changping_ = changping_data.groupby(by='datetime').agg({"SO2":["mean"]})
...
# Menampilkan NO2 di Kota Changping
st.subheader("Indeks Polusi NO2 di Kota Changping")
changping_ = changping_data.groupby(by='datetime').agg({"NO2":["mean"]})
...
# Menampilkan CO di Kota Changping
st.subheader("Indeks Polusi CO di Kota Changping")
changping_ = changping_data.groupby(by='datetime').agg({"CO":["mean"]})
...
# Menampilkan O3 di Kota Changping
st.subheader("Indeks Polusi O3 di Kota Changping")
changping_ = changping_data.groupby(by='datetime').agg({"O3":["mean"]})
...
# Menampilkan SO2 di Kota Shunyi
st.subheader("Indeks Polusi SO2 di Kota Shunyi")
shunyi_data = all_df[all_df['station'] == 'Shunyi']
shunyi_ = shunyi_data.groupby(by='datetime').agg({"SO2":["mean"]})
...
# Menampilkan NO2 di Kota Shunyi
st.subheader("Indeks Polusi NO2 di Kota Shunyi")
shunyi_data = all_df[all_df['station'] == 'Shunyi']
shunyi_ = shunyi_data.groupby(by='datetime').agg({"NO2":["mean"]})
...
# Menampilkan CO di Kota Shunyi
st.subheader("Indeks Polusi CO di Kota Shunyi")
shunyi_data = all_df[all_df['station'] == 'Shunyi']
shunyi_ = shunyi_data.groupby(by='datetime').agg({"CO":["mean"]})
...
# Menampilkan O3 di Kota Shunyi
st.subheader("Indeks Polusi O3 di Kota Shunyi")
shunyi_data = all_df[all_df['station'] == 'Shunyi']
shunyi_ = shunyi_data.groupby(by='datetime').agg({"O3":["mean"]})
